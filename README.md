...
**주요 결과** — 주방 오탐 88.0% → 1.3% (판별비 25배) · 웹3D 렌더 화면에서 **실사 픽셀 0장인 절차적 화염 81.0% 탐지**(IoU 0.5 기준 70.0%) · 6~7회차에서 **smoke 클래스 시도** — 화염 회귀는 없었으나 조리 연기/수증기 판별비 0.54 → 0.75로 1을 넘지 못해 **연기 조기 경보는 미해결 과제로 종결**(단일 프레임 한계)
...
![6회차 대비](docs/round7_compare.png)
